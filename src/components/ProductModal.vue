    ...
    >
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content border-0">
                  ...
                  >
                    <template #item="{ element }">
                      <div class="position-relative item">
                        <div
                          class="d-flex gap-2 border justify-content-between align-items-end rounded-3 p-2"
                        >
                          <div
                          ...
                          <div class="overflow-hidden">
                            ...
                            <input
                              type="text"
                              class="form-control form-control fs-6 h-50"
                              style="font-size: 1px"
                              v-model="element.url"
                              placeholder="請輸入連結"
                            />
          ...
          <CropperModal
            @confirm-cropper="updateImages"
            @close="openModal"
            v-if="isCropper"
            class="cropperModal_open"
            :class="{ cropperModal_close: !isCropper }"
            :tempImg="tempImg"
            v-click-away="onClickAway"
          >
          </CropperModal>
