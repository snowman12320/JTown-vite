  ...
  >
    ...
    >
      <div class="modal-content">
        ...
        <div
          class="modal-body"
          style="white-space: pre-wrap; line-height: 2"
          @scroll="handleScroll"
          ref="element"
        >
          <div>
            <div>
              當您開始使用"JTown"的服務時，即表示您已閱讀、瞭解並同意接受本使用條款。如果您不同意接受本使用條款，即無法使用"JTown"的服務。
            </div>
            <div>1. 您與"JTown"的關係</div>
            <div>1.1</div>
            <div>
              本使用條款是用來規範您如何使用「"JTown"平台」("JTown")、及其他任何由我們提供的線上或線下服務，以及用來規範您透過"JTown"所進行的旅遊消費行為（統稱「"JTown"的服務」）。
            </div>
            <div>1.2</div>
            <div>
            ...
            <div>2.2</div>
            <div>
              您可能因為使用"JTown"的服務而須對供應商支付費用，您也會被要求遵守供應商的服務約款。您瞭解也同意您對於這些費用須負全部的責任，且也同意支付這些費用，以及遵守他們的服務約款。
            </div>
            <div>2.3</div>
            <div>
            ...
            <div>
              未經我們的事前書面授權，您不得抄襲、重製、散布、公開發表、展示、傳送或公開播送"JTown"的服務的任何部份，包括但不限於以下任何未經我們事前明確同意之行為：
            </div>
            <div>(i) 改變、毀損或規避任何"JTown"的服務所使用的授權軟體；及 (ii)</div>
            <div>
              使用屬於我們或從"JTown"的服務取得的任何商標、服務標章、設計標章、照片或其他內容。
            </div>
            <div>(b)</div>
            <div>
              您不得規避、損害或妨礙任何用來控制"JTown"的服務使用秩序的安全措施，從"JTown"的服務獲取或挖掘服務內容，或以不符個人使用方式的方法使用"JTown"的服務。
            </div>
            <div>(c)</div>
            <div>
            ...
            <div>(e)</div>
            <div>
              您不得進入、損害或使用"JTown"的服務未公開的區域、"JTown"（及"JTown"的虛擬主機公司）的電腦系統及設備，或我們網路服務提供業者的技術接收系統。
            </div>
            <div>(f)</div>
            <div>
            ...
            <div>
              您不得限制或禁止任何人使用"JTown"的服務、未經第三人同意揭露"JTown"的服務上或從"JTown"的服務取得的第三人個人資料，或蒐集有關使用者的資料。
            </div>
            <div>(j)</div>
            <div>
              除非本使用條款明示許可，否則您不得使用"JTown"的服務聯絡或從事任何商業廣告或資料蒐集。
            </div>
            <div>(k)</div>
            <div>
            ...
            <div>7.2</div>
            <div>
              您同意您任何與"JTown"平台往來或傳輸的內容不具有機密性，且您的通訊內容可能被他人閱讀或截取。您瞭解並確認，您與我們之間未建立任何機密、信託或其他合作性質的法律關係。
            </div>
            <div>7.3</div>
            <div>
