  ...
  methods: {
    ...
    getStory(id = this.productListId) {
      ...
      this.$http
        ...
        .catch((error) => {
          this.$toast("error", " Error fetching story:" + error);
        });
    },
    getStoryList(page = 1) {
      const api = `${import.meta.env.VITE_APP_API}api/${
...
<template>
  <div>
        ...
        <ul class="pagination w-100 d-flex justify-content-between">
          <li class="page-item" :class="{ disabled: isNotPrev }">
            <a
              ...
              href="#"
            >
              <i class="fa fa-caret-left" aria-hidden="true" /> Prev
            </a>
          </li>
          <li class="page-item" :class="{ disabled: isNotNext }">
            <a
              ...
              href="#"
            >
              Next <i class="fa fa-caret-right" aria-hidden="true"
            /></a>
          </li>
        </ul>
      </nav>
    ...
    <div class="container-xxl my-3">
      <p class="fs-6 text-secondary text-center mb-5">
      ...
      >
        ...
        <aside
          class="col col-xl-4 sticky-xl-top align-self-start"
          style="z-index: 5; top: 100px"
        >
